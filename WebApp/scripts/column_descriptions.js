let descriptions = {
	...
	"speech.date": {
		"en":"Date when the speech was given in the format of YYYY-MM-DD"
	},
	"person.sex": {
		"en":"Sex of the person, M is for male, F for female, there may be some people for who this information is missing."	
	},
	"speech.term": {
	...
	"speech.artif_dow": {
		"en":"Day of the week when the speech was given. A number from 0-6 where 0 is Sunday and 6 is Saturday."		
	},
	"speech.artif_month": {
		"en":"Month when the speech was given. A number from 1(January) to 12(December)"
	},
	"speech.artif_year": {
	...
	"speech.role": {
		"en":"Role of the speaker within the sitting, i.e. regular, quest etc."
	},
	"organisation.name": {
	...
	"speech.earliest_timestamp": {
		"en":"Time when the speaker started giving the speech in the format of HH:MM:SS. May not be completely accurate due to potential issues in audio alignment. Only available for ParCzech!"
	},
	"speech.latest_timestamp": {
		"en":"Time when the speaker ended their speech in the format of HH:MM:SS. May not be completely accurate due to potential issues in audio alignment. Only available for ParCzech!"
	}
}
